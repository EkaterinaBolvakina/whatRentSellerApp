...
public class SellerRequestDto {
    ...
    @NotBlank(message = "Seller business name must be not blank")
    private String businessName;

    @NotBlank(message = "Seller first name must be not blank")
    private String firstName;
    @NotBlank(message = "Seller last name must be not blank")
